...
<label class="cursor-pointer grid place-items-center my-3">
    <input type="checkbox" bind:checked={isChecked} on:change={toggleTheme} value="synthwave" class="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2"/>
